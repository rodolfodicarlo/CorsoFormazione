...
namespace Corso.WebApi.Controllers
{
    ...
    public class StudenteController : BaseApiController
    {
        ...
        /// </summary>
        /// <param name="studenteService"></param>
        /// <param name="mapper"></param>
        /// <param name="logger"></param>
        public StudenteController(IStudenteService studenteService, IMapper mapper, ILogger<BaseApiController> logger) : base(logger)
        {
        ...
        /// </summary>
        /// <returns>Una lista di di oggetti <see cref="StudenteDTO"/></returns>
        ...
        /// </summary>
        /// <param name="model">Il modello contenete i dati per la creazione di un nuovo studente .</param>
        ...
        /// <returns>L'ID dello studente eliminata.</returns>
